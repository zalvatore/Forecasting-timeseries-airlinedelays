...
autoplot(Airline_Delays_Pit.train.ts, series = 'Train') +
  autolayer(Airline_Delays_Pit.valid.ts, series = 'Valid')
...
wine.hwin <- ets(Airline_Delays_Pit.train.ts,
                 model = "AAM",
                 alpha = .2,
                 gamma = .05,
                 restrict = FALSE
