...
Airline_Delays_Pit.train <- window(arr_delays_pit.ts, end = c(2021,12))
Airline_Delays_Pit.test <- window(arr_delays_pit.ts, start = c(2022,1))
...
#out <- Airline_Delays_Pit[(order(as.Date(Airline_Delays_Pit$date))),]
Airline_Delays_Pit_sum
